...
// "Run" tab of the Options Backtest page (see OptionsBacktest.tsx for the
// tab host and OptionsAnalysis.tsx for the "Analysis" tab). Mirrors
// pages/BacktestRun.tsx's results display exactly (SummaryCardRow/
...
export function OptionsBacktestRun() {
